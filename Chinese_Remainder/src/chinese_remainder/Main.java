 ...
 * 
 * @since 17-March-2018
 * Having a proper flow being created for the condition when only 
 * the input that is provided by the user is less than 100.  If
 * the input is greater than 100, then a message will be output
 * saying that the input is too large.
 */
...
{ 
    ...
    { 
    	...
    	// Prompting for the user to enter in any number
    	System.out.println("Enter in a value to find the factors!");
        ...
        {
        	System.out.println("Your provided input: " + n + " is too large"); 
        }
    }
     ...
     * @return An integer array which helps in confirming that we have returned an array 
     * of integers. 
     */
